package com.example.rolex.util;
...
public final class AppPreferences {
    ...
    public static final int PERIOD_NOTIFICATION_ID = 1;
    public static final int FERTILE_NOTIFICATION_ID = 2;
    public static final int OVULATION_NOTIFICATION_ID = 3;

    private AppPreferences() { }

    public static final String APPLICATION_PREFIX = "com.example.rolex.";
